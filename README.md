This React app contain multiple mini-projects.
## ✅ Completed Projects
- **Calculator** – Basic calculator using React hooks.
- **PasswordStrengther** – Password strength checker.
- **Quiz** – Interactive multiple-choice quiz app.
